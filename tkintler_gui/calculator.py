...
button_mul= Button(root,text ='*' , padx=40.4,pady=20 , command= button_mul)
button_div= Button(root,text ='/' , padx=40.8,pady=20 , command= button_div)
button_equal = Button(root,text ='=' , padx=133.5,pady=20 , command= button_equal)
